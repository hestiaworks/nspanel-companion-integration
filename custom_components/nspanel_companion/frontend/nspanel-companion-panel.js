  ...
  pagePreview(page, miniature = false) {
    ...
    const widgetMarkup = widgets.length ? widgets.map((widget) => {
      ...
      if (widget.type === "thermostat") {
        ...
        return `<div class="preview-climate dual"><div class="climate-ring"><svg class="climate-dial" viewBox="0 0 200 200" aria-hidden="true"><path class="dial-track" d="M 45 160 A 78 78 0 1 1 155 160"/><path class="dial-heat" d="M 45 160 A 78 78 0 0 1 36 50"/><path class="dial-cool" d="M 164 50 A 78 78 0 0 1 155 160"/><circle class="dial-handle heat" cx="36" cy="50" r="6"/><circle class="dial-handle cool" cx="164" cy="50" r="6"/></svg><small>CURRENT</small><strong>${escapeHtml(actual)}°</strong><div class="ring-target heat">${escapeHtml(heat)}°</div><div class="ring-target cool">${escapeHtml(cool)}°</div></div><div class="target-picker"><button class="selected" type="button"><small>HEAT BELOW</small><b>${escapeHtml(heat)}°</b></button><button type="button"><small>COOL ABOVE</small><b>${escapeHtml(cool)}°</b></button></div><div class="target-stepper"><button type="button">−</button><span>Adjust heat target</span><button type="button">＋</button></div><div class="preview-modes"><b>Heat</b><b>Cool</b><b class="active">Auto</b><b>Fan</b><b>Dry</b><b>Off</b></div></div>`;
      }
